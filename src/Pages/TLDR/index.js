  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.back}>
        <a className={styles.bookContainer} href={"/"}>
          <img className={styles.book} src={book} alt="logo" />
          <div className={styles.text}>Back to book?</div>
        </a>{" "}
      </div>
    </div>
  );
